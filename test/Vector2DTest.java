...
public class Vector2DTest {
   ...
   public void rotateMe() {
      ...
      v1.rotateMe(0.5236f);
      assertEquals(0.5236f, v1.getAngleX());
   }
   ...
   public void rotate() {
      ...
      assertEquals(0.5236f, rotated.getAngleX());
   }

/*   @Test
   public void getPerpendicularTest() {
      Vector2D v1 = new Vector2D(5, 3);
      assertTrue(v1.rotate((float)Math.toRadians(90)).similar(v1.getPerpendicular()));      
   }
*/
   
   @Test
   public void normalizeMe() {
      Vector2D v1 = Vector2D.createBySizeAngle(10, (float)Math.toRadians(10));
      v1.normalizeMe();
